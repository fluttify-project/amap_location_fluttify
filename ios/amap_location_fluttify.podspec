...
Pod::Spec.new do |s|
  ...
  s.version          = '0.0.1'
  s.summary          = 'An `Amap` Location Component, Powered By `Fluttify` Engine, A Dart Bindings Generator For Native SDK.'
  s.description      = <<-DESC
A new flutter plugin project.
  ...
  # s.resource_bundles = {
  #   'amap_location_fluttify' => ['Vendor/*.framework/*.bundle']
  # }
end
