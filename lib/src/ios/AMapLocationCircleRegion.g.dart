...
class AMapLocationCircleRegion extends AMapLocationRegion with NSCopying {
  ...
  static Future<AMapLocationCircleRegion> create__() async {
    final refId = await MethodChannel('me.yohom/amap_location_fluttify', StandardMethodCodec(FluttifyMessageCodec())).invokeMethod('ObjectFactory::createAMapLocationCircleRegion');
  ...
  Future<CLLocationCoordinate2D> get_center() async {
    final __result__ = await MethodChannel('me.yohom/amap_location_fluttify', StandardMethodCodec(FluttifyMessageCodec())).invokeMethod("AMapLocationCircleRegion::get_center", {'__this__': this});
    return CLLocationCoordinate2D()..refId = __result__..tag__ = 'amap_location_fluttify';
  }
  
  Future<double> get_radius() async {
    final __result__ = await MethodChannel('me.yohom/amap_location_fluttify', StandardMethodCodec(FluttifyMessageCodec())).invokeMethod("AMapLocationCircleRegion::get_radius", {'__this__': this});
    return __result__;
  }
...
extension AMapLocationCircleRegion_Batch on List<AMapLocationCircleRegion> {
  ...
  Future<List<CLLocationCoordinate2D>> get_center_batch() async {
    final resultBatch = await MethodChannel('me.yohom/amap_location_fluttify', StandardMethodCodec(FluttifyMessageCodec())).invokeMethod("AMapLocationCircleRegion::get_center_batch", this);
  ...
  Future<List<double>> get_radius_batch() async {
    final resultBatch = await MethodChannel('me.yohom/amap_location_fluttify', StandardMethodCodec(FluttifyMessageCodec())).invokeMethod("AMapLocationCircleRegion::get_radius_batch", this);
