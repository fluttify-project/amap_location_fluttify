...
class AMapGeoFenceManager extends NSObject  {
  ...
  Future<void> addPolygonRegionForMonitoringWithCoordinates_count_customID(List<CLLocationCoordinate2D> coordinates, int count, String customID) async {
    ...
    // invoke native method
    final __result__ = await MethodChannel('me.yohom/amap_location_fluttify').invokeMethod('AMapGeoFenceManager::addPolygonRegionForMonitoringWithCoordinates_count_customID', {"coordinates": coordinates.map((it) => it.refId).toList(), "count": count, "customID": customID, "refId": refId});
  ...
  Future<List> geoFenceRegionsWithCustomID(String customID) async {
    ...
    if (__result__ == null) {
      ...
      kNativeObjectPool.addAll((__result__ as List).cast<int>().map((__it__) => NSObject()..refId = __it__..tag = 'amap_location_fluttify').toList());
      return (__result__ as List).cast<int>().map((__it__) => NSObject()..refId = __it__..tag = 'amap_location_fluttify').toList();
    }
  }
...
extension AMapGeoFenceManager_Batch on List<AMapGeoFenceManager> {
  ...
  Future<List<AMapGeoFenceActiveAction>> get_activeAction_batch() async {
    ...
    final typedResult = (resultBatch as List).map((__result__) => AMapGeoFenceActiveAction.values[__result__]).toList();
  ...
  Future<List<AMapGeoFenceRegionActiveStatus>> statusWithGeoFenceRegion_batch(List<AMapGeoFenceRegion> region) async {
    ...
    if (resultBatch == null) {
      ...
      final typedResult = (resultBatch as List).map((__result__) => AMapGeoFenceRegionActiveStatus.values[__result__]).toList();
  ...
  Future<List<List>> geoFenceRegionsWithCustomID_batch(List<String> customID) async {
    ...
    if (resultBatch == null) {
      ...
      final typedResult = (resultBatch as List).map((__result__) => (__result__ as List).cast<int>().map((__it__) => NSObject()..refId = __it__..tag = 'amap_location_fluttify').toList()).toList();
