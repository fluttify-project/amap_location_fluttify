...
class AMapGeoFenceDistrictRegion extends AMapGeoFenceRegion with NSCopying {
  ...
  static Future<AMapGeoFenceDistrictRegion> create__() async {
    final int refId = await MethodChannel('me.yohom/amap_location_fluttify', StandardMethodCodec(FluttifyMessageCodec())).invokeMethod('ObjectFactory::createAMapGeoFenceDistrictRegion');
  ...
  Future<AMapLocationDistrictItem> get_districtItem() async {
    final __result__ = await MethodChannel('me.yohom/amap_location_fluttify', StandardMethodCodec(FluttifyMessageCodec())).invokeMethod("AMapGeoFenceDistrictRegion::get_districtItem", {'refId': refId});
...
extension AMapGeoFenceDistrictRegion_Batch on List<AMapGeoFenceDistrictRegion> {
  ...
  Future<List<AMapLocationDistrictItem>> get_districtItem_batch() async {
    final resultBatch = await MethodChannel('me.yohom/amap_location_fluttify', StandardMethodCodec(FluttifyMessageCodec())).invokeMethod("AMapGeoFenceDistrictRegion::get_districtItem_batch", [for (final __item__ in this) {'refId': __item__.refId}]);
    final typedResult = (resultBatch as List).cast<int>().map((__result__) => AMapLocationDistrictItem()..refId = __result__..tag__ = 'amap_location_fluttify').toList();
