...
class com_amap_api_fence_DistrictItem extends java_lang_Object with android_os_Parcelable {
  ...
  Future<List<com_amap_api_location_DPoint>> getPolyline() async {
    ...
    if (result == null) {
      ...
      kNativeObjectPool.addAll((result as List).cast<int>().map((__it__) => com_amap_api_location_DPoint()..refId = __it__..tag = 'amap_location_fluttify').toList());
      return (result as List).cast<int>().map((__it__) => com_amap_api_location_DPoint()..refId = __it__..tag = 'amap_location_fluttify').toList();
    }
  }
...
extension com_amap_api_fence_DistrictItem_Batch on List<com_amap_api_fence_DistrictItem> {
  ...
  Future<List<List<com_amap_api_location_DPoint>>> getPolyline_batch() async {
    ...
    if (resultBatch == null) {
      ...
      final typedResult = (resultBatch as List).map((result) => (result as List).cast<int>().map((__it__) => com_amap_api_location_DPoint()..refId = __it__..tag = 'amap_location_fluttify').toList()).toList();
