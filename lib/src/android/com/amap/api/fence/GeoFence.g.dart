...
class com_amap_api_fence_GeoFence extends java_lang_Object with android_os_Parcelable {
  ...
  Future<void> setPendingIntent(android_app_PendingIntent var1) async {
    ...
    // invoke native method
    final __result__ = await MethodChannel('me.yohom/amap_location_fluttify').invokeMethod('com.amap.api.fence.GeoFence::setPendingIntent', {"var1": var1.refId, "refId": refId});
  ...
  Future<com_amap_api_fence_PoiItem> getPoiItem() async {
    ...
    if (__result__ == null) {
      ...
      kNativeObjectPool.add(com_amap_api_fence_PoiItem()..refId = __result__..tag = 'amap_location_fluttify');
      return com_amap_api_fence_PoiItem()..refId = __result__..tag = 'amap_location_fluttify';
    }
  }
  ...
  Future<void> setPoiItem(com_amap_api_fence_PoiItem var1) async {
    ...
    // invoke native method
    final __result__ = await MethodChannel('me.yohom/amap_location_fluttify').invokeMethod('com.amap.api.fence.GeoFence::setPoiItem', {"var1": var1.refId, "refId": refId});
  ...
  Future<List<com_amap_api_fence_DistrictItem>> getDistrictItemList() async {
    ...
    if (__result__ == null) {
      ...
      kNativeObjectPool.addAll((__result__ as List).cast<int>().map((__it__) => com_amap_api_fence_DistrictItem()..refId = __it__..tag = 'amap_location_fluttify').toList());
      return (__result__ as List).cast<int>().map((__it__) => com_amap_api_fence_DistrictItem()..refId = __it__..tag = 'amap_location_fluttify').toList();
    }
  }
  ...
  Future<void> setDistrictItemList(List<com_amap_api_fence_DistrictItem> var1) async {
    ...
    // invoke native method
    final __result__ = await MethodChannel('me.yohom/amap_location_fluttify').invokeMethod('com.amap.api.fence.GeoFence::setDistrictItemList', {"var1": var1.map((it) => it.refId).toList(), "refId": refId});
  ...
  Future<void> setCenter(com_amap_api_location_DPoint var1) async {
    ...
    // invoke native method
    final __result__ = await MethodChannel('me.yohom/amap_location_fluttify').invokeMethod('com.amap.api.fence.GeoFence::setCenter', {"var1": var1.refId, "refId": refId});
  ...
  Future<void> setCurrentLocation(com_amap_api_location_AMapLocation var1) async {
    ...
    // invoke native method
    final __result__ = await MethodChannel('me.yohom/amap_location_fluttify').invokeMethod('com.amap.api.fence.GeoFence::setCurrentLocation', {"var1": var1.refId, "refId": refId});
...
extension com_amap_api_fence_GeoFence_Batch on List<com_amap_api_fence_GeoFence> {
  ...
  Future<List<com_amap_api_fence_PoiItem>> getPoiItem_batch() async {
    ...
    if (resultBatch == null) {
      ...
      final typedResult = (resultBatch as List).map((__result__) => com_amap_api_fence_PoiItem()..refId = __result__..tag = 'amap_location_fluttify').toList();
      kNativeObjectPool.addAll(typedResult);
      return typedResult;
    }
  }
  ...
  Future<List<List<com_amap_api_fence_DistrictItem>>> getDistrictItemList_batch() async {
    ...
    if (resultBatch == null) {
      ...
      final typedResult = (resultBatch as List).map((__result__) => (__result__ as List).cast<int>().map((__it__) => com_amap_api_fence_DistrictItem()..refId = __it__..tag = 'amap_location_fluttify').toList()).toList();
