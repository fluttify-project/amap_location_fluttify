...
mixin com_amap_api_location_LocationManagerBase on java_lang_Object {
  ...
  Future<void> setLocationOption(com_amap_api_location_AMapLocationClientOption var1) async {
    ...
    final __result__ = await MethodChannel('me.yohom/amap_location_fluttify').invokeMethod('com.amap.api.location.LocationManagerBase::setLocationOption', {"var1": var1 is Ref ? (var1 as Ref)?.refId : var1, "refId": refId});
  ...
  Future<void> enableBackgroundLocation(int var1, android_app_Notification var2) async {
    ...
    // invoke native method
    final __result__ = await MethodChannel('me.yohom/amap_location_fluttify').invokeMethod('com.amap.api.location.LocationManagerBase::enableBackgroundLocation', {"var1": var1, "var2": var2 is Ref ? (var2 as Ref)?.refId : var2, "refId": refId});
