...
class com_amap_api_location_APSService extends java_lang_Object  {
  ...
  static Future<com_amap_api_location_APSService> create__() async {
    final refId = await kAmapLocationFluttifyChannel.invokeMethod('ObjectFactory::createcom_amap_api_location_APSService__', );
    final object = com_amap_api_location_APSService()..refId = refId;
    return object;
  }
  ...
  static Future<List<com_amap_api_location_APSService>> create_batch__(int length) async {
    ...
    final List resultBatch = await kAmapLocationFluttifyChannel.invokeMethod('ObjectFactory::create_batchcom_amap_api_location_APSService__', {'length': length});
  
    final List<com_amap_api_location_APSService> typedResult = resultBatch.map((result) => com_amap_api_location_APSService()..refId = result).toList();
    return typedResult;
  }
