...
class com_amap_api_location_CoordUtil extends java_lang_Object  {
  ...
  static Future<com_amap_api_location_CoordUtil> create__() async {
    final int refId = await MethodChannel('me.yohom/amap_location_fluttify', StandardMethodCodec(FluttifyMessageCodec())).invokeMethod('ObjectFactory::createcom_amap_api_location_CoordUtil__');
