...
class com_amap_api_location_AMapLocationClientOption extends java_lang_Object with android_os_Parcelable {
  ...
  Future<com_amap_api_location_AMapLocationClientOption> setMockEnable(bool var1) async {
    ...
    if (result == null) {
      ...
      kNativeObjectPool.add(com_amap_api_location_AMapLocationClientOption()..refId = result..tag = 'amap_location_fluttify');
      return com_amap_api_location_AMapLocationClientOption()..refId = result..tag = 'amap_location_fluttify';
    }
  }
...
extension com_amap_api_location_AMapLocationClientOption_Batch on List<com_amap_api_location_AMapLocationClientOption> {
  ...
  Future<List<com_amap_api_location_AMapLocationClientOption>> setMockEnable_batch(List<bool> var1) async {
    ...
    if (resultBatch == null) {
      ...
      final typedResult = (resultBatch as List).map((result) => com_amap_api_location_AMapLocationClientOption()..refId = result..tag = 'amap_location_fluttify').toList();
      kNativeObjectPool.addAll(typedResult);
      return typedResult;
    }
  }
  ...
  Future<List<com_amap_api_location_AMapLocationClientOption_AMapLocationMode>> getLocationMode_batch() async {
    ...
    if (resultBatch == null) {
      ...
      final typedResult = (resultBatch as List).map((result) => com_amap_api_location_AMapLocationClientOption_AMapLocationMode.values[result]).toList();
  ...
  Future<List<com_amap_api_location_AMapLocationClientOption_AMapLocationProtocol>> getLocationProtocol_batch() async {
    ...
    if (resultBatch == null) {
      ...
      final typedResult = (resultBatch as List).map((result) => com_amap_api_location_AMapLocationClientOption_AMapLocationProtocol.values[result]).toList();
  ...
  Future<List<com_amap_api_location_AMapLocationClientOption_GeoLanguage>> getGeoLanguage_batch() async {
    ...
    if (resultBatch == null) {
      ...
      final typedResult = (resultBatch as List).map((result) => com_amap_api_location_AMapLocationClientOption_GeoLanguage.values[result]).toList();
  ...
  Future<List<com_amap_api_location_AMapLocationClientOption_AMapLocationPurpose>> getLocationPurpose_batch() async {
    ...
    if (resultBatch == null) {
      ...
      final typedResult = (resultBatch as List).map((result) => com_amap_api_location_AMapLocationClientOption_AMapLocationPurpose.values[result]).toList();
